...
CREATE TABLE `museum` (
  ...
  `museumName` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`museumID`),
  UNIQUE KEY `museumName` (`museumName`)
...
INSERT INTO `museum` VALUES (3,'Indiana Museum'),(1,'Metropolitan Museum of Art, New York, NY'),(2,'MFA Boston');
...
-- Dump completed on 2022-12-09 13:05:00
